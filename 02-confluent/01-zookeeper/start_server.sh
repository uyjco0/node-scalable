...
ZK_CFG_FILE="${CONFLUENT_FOLDER}/etc/kafka/zookeeper.properties"
...
/usr/sbin/docker-edit-properties --preserve-case --file ${ZK_CFG_FILE} --include 'ZK_(.*)' --include 'zk_(.*)' --exclude '^zk_cfg_'

exec ${CONFLUENT_FOLDER}/bin/zookeeper-server-start ${ZK_CFG_FILE}
